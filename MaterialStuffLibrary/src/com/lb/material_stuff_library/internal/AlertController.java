package com.lb.material_stuff_library.internal;
...
public class AlertController
  ...
  public AlertController(final Context context,final DialogInterface di,final Window window)
    ...
    final TypedArray a=context.obtainStyledAttributes(null,R.styleable.AlertDialogProStyle,R.attr.alertDialogProStyle,0);
    mAlertDialogLayout=a.getResourceId(R.styleable.AlertDialogProStyle_adpLayout,R.layout.msl__alert_dialog_material);
    mListLayout=a.getResourceId(R.styleable.AlertDialogProStyle_adpListLayout,R.layout.msl__select_dialog_material);
    mMultiChoiceItemLayout=a.getResourceId(R.styleable.AlertDialogProStyle_adpMultiChoiceItemLayout,R.layout.msl__select_dialog_multichoice_material);
    mSingleChoiceItemLayout=a.getResourceId(R.styleable.AlertDialogProStyle_adpSingleChoiceItemLayout,R.layout.msl__select_dialog_singlechoice_material);
    mListItemLayout=a.getResourceId(R.styleable.AlertDialogProStyle_adpListItemLayout,R.layout.msl__select_dialog_item_material);
    a.recycle();
    }
  ...
  /**
   * @see com.lb.material_stuff_library.AlertDialogPro.Builder#setCustomTitle(View)
   */
  ...
  private void setupView()
    ...
    else mWindow.findViewById(R.id.customPanel).setVisibility(View.GONE);
    /*
    ...
    if(hasTitle)
      ...
      // else divider=mWindow.findViewById(R.id.titleDividerTop);
      // if(divider!=null)
